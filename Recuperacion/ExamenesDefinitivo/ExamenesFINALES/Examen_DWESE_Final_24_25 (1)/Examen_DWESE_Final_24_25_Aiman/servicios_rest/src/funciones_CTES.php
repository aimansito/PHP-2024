...
function obtener_profesores_guardias($id_usuario){
    ...
    try{
        $consulta="select horario_lectivo.dia , horario_lectivo.hora, horario_lectivo.grupo, horario_lectivo.aula from horario_lectivo, aulas, grupos where horario_lectivo.aula=aulas.id_aula and horario_lectivo.grupo=grupos.id_grupo and usuario=?";
        $sentencia=$conexion->prepare($consulta);
