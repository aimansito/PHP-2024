...
function obtener_horario_grupo($id_grupo){
    ...
    try{
        $consulta="select horario_lectivo.dia, horario_lectivo.hora, usuarios.nombre as profe, aulas.nombre as aula from horario_lectivo, usuarios, aulas where horario_lectivo.usuario=usuarios.id_usuario and horario_lectivo.aula=aulas.id_aula and horario_lectivo.grupo=?";
        $sentencia=$conexion->prepare($consulta);
    ...
    $respuesta["horario_profesor"]=$sentencia->fetchAll(PDO::FETCH_ASSOC);
