...
if(isset($_POST["btnLogin"]))
{
    ...
    if(!$error_form_login)
    {
        ...
        {
            session_destroy();
            die(error_page("Práctica 5 - Rec","<h1>Práctica 5 - Rec</h1><p>Error consumiendo el servicio: ".$url."</p>"));
        }

        if(isset($json_respuesta["error"]))
        {
            session_destroy();
            die(error_page("Práctica 5 - Rec","<h1>Práctica 5 - Rec</h1><p>".$json_respuesta["error"]."</p>"));
        }
        ...
        if(isset($json_respuesta["usuario"]))
        {
            ...
            if($json_respuesta["usuario"]["tipo"]=="normal")
