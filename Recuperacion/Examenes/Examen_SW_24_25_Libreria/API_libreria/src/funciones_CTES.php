...
function obtener_libros(){
    ...
    if($sentencia->rowCount()>0){
        ...
        $respuesta["mensaje"]="No existen libros registrados";
    }
...
function borrar_libro($referencia){
    ...
    $respuesta["mensaje"]="Libro borrado correctamente de la BD";
    $sentencia=null;
    $conexion=null;
    return $respuesta;
}
...
function actualizar_portada($datos){
    ...
    $respuesta['mensaje']="Portada del libro".end($datos)." cambiada correctamente en la BD";
    $sentencia=null;
    $conexion=null;
    return $respuesta;
}
