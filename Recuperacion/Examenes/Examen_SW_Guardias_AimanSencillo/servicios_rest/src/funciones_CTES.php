...
function usuariosGuardia($dia,$hora){
    ...
    try{
        $consulta="SELECT usuarios.nombre, usuarios.id_usuarios FROM horarios_guardias, usuarios WHERE horario_guardias.usuario=usuarios.id_usuario and horario_guardias.dia=? and horario_guardias.hora=?";
        $sentencia=$conexion->prepare($consulta);
