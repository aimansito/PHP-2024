<?php
    ...
    {
        session_destroy();
        die(error_page("Gestión Guardias","<h1>Guardias</h1><p>Error consumiendo el servicio Rest: <strong>".$url."</strong></p>"));
    }
    if(isset($json_respuesta["error"]))
    {
        session_destroy();
        die(error_page("Gestión Guardias","<h1>Guardias</h1><p>".$json_respuesta["error"]."</p>"));
    }
